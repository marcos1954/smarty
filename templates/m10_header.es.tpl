...
<title>{$PAGE_TITLE|default:"Gay Guide Vallarta | La Guía Gay de Vallarta"}</title>
...
<body>
 ...
 <a href="/?menu="><img src="/m/gPVR.png" width="187" height="130" /></a></div>
<div style="float: right;" >{$LANG_FLAGS}</div>
...
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-4e0ceb6257dfd8d8"></script>
</div>
<div id="main">
